...
$${\color{#ffc9e4}Avdol's \space loverboy!}$$
<p align="center">
...
$${\color{#ff8cad}people \space that \space claim \space the \space same \space irl/kinnie \space as \space i \space do,\space dni!}$$
...
small reminder: 
<code style="color:#ff85be "> NO i do not have DID or OSDD, and i do not diagnose myself with any of them.
